# Validation — EXP-043 (grilla 5x4, EURUSD REAL)
...
## Configuracion
- extremo (oversold/overbought): 20/80
- separacion (MIN_SEPARATION): 3  (NOTA: no impacto el embudo; ver hallazgo)
- dominio: REAL (EURUSD M15), payout 0.85, seed 42

## Resultados
- nacidos: 13635
- completas (embudo): 1524
- WR: 0.523
- EV neto: -0.5555
- p (binom vs 0.50): 0.0771
- p_adj FDR: 0.38556
- p_adj Bonferroni: 1.0

## Veredicto del tribunal
- **REFUTADA** (p_adj_fdr=0.38556 >= alpha 0.05)
- EV neto -0.5555 (negativo: el costo de payout 0.85 supera el WR).
...
## Reproducibilidad
- dataset_hash: sha256:4897a796d0d56fe5
