...
```
src/edificio_tools/
  __init__.py     # exponte Evidence, Tool, load_catalog, get_tool
  ...
  assembler.py    # (R4) ENSAMBLADOR  [Fase B, pendiente]
  inspector.py    # (R5) INSPECTOR    [Fase B, pendiente]
  governor.py     # (R6) GOBERNADOR   [Fase C, pendiente]
```
