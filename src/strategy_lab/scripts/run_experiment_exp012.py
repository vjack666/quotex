"""Ejecuta EXP-012: brake_transition (1.5, 1.5) + horizonte 2 velas."""
...
REPORT_DIR = Path("src/strategy_lab/results/exp_012")
...
def main() -> None:
    ...
    artifacts = run_experiment(
        ...
        events=events,
        hypothesis="H1-brake-quality-1.5-1.5-horizon2",
    ...
    if artifacts.gate_decision is None:
        raise RuntimeError("EXP-012 did not produce a gate decision")
