"""Ejecuta EXP-005: solo freno en zona POI sin cruce ni martillo."""
...
REPORT_DIR = Path("src/strategy_lab/results/exp_005")
...
def main() -> None:
    ...
    for pair in PAIRS:
        ...
        mask = feats["brake_transition"] & feats["cruce_en_zona"]
    ...
    artifacts = run_experiment(
        ...
        events=events,
        hypothesis="H1-brake-en-zona-POI-sin-cruce",
    ...
    if artifacts.gate_decision is None:
        raise RuntimeError("EXP-005 did not produce a gate decision")
