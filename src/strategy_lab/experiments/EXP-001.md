...
Validar si combinar separación K/D amplia con un tiempo mínimo
desde freno hasta cruce mejora la calidad estadística del Edificio.

## Hipótesis

H1: Las entradas con `cross_separation >= 4.5` y `minutes_brake_to_cross >= 16`
tienen win rate y EV positivas, sobreviviendo al tribunal v1.0.
...
- Código: `src/strategy_lab/experiment_runner.py`
