"""Ejecuta EXP-023: consistencia 3/5 con evaluación en idx+3."""
...
REPORT_DIR = Path("src/strategy_lab/results/exp_023")
...
def main() -> None:
    ...
    artifacts = run_experiment(
        ...
        events=events,
        hypothesis="H1-brake-multi-horizon-consistency-idx3",
    ...
    if artifacts.gate_decision is None:
        raise RuntimeError("EXP-023 did not produce a gate decision")
