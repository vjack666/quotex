...
4. Marcar evento como válido si gana en >=2 de 5 horizontes.
...
- `regla`: brake_transition=1 AND wins>=2/5 en horizontes 1-5

## Aislamiento

Prueba UNA condición: freno con consistencia relajada.
