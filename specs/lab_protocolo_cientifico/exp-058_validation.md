# Validation — EXP-058 (grilla 5x4, EURUSD REAL)
...
## Configuracion
- extremo (oversold/overbought): 40/60
- separacion (MIN_SEPARATION): 2  (NOTA: no impacto el embudo; ver hallazgo)
- dominio: REAL (EURUSD M15), payout 0.85, seed 42

## Resultados
- nacidos: 13635
- completas (embudo): 5360
- WR: 0.4959
- EV neto: -0.5785
- p (binom vs 0.50): 0.5570
- p_adj FDR: 0.38556
- p_adj Bonferroni: 1.0

## Veredicto del tribunal
- **REFUTADA** (p_adj_fdr=0.38556 >= alpha 0.05)
- EV neto -0.5785 (negativo: el costo de payout 0.85 supera el WR).
...
## Reproducibilidad
- dataset_hash: sha256:43b3b39f43001138
