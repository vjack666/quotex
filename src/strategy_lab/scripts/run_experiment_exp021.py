"""Ejecuta EXP-021: brake_transition con consistencia temporal endurecida (4/5)."""
...
REPORT_DIR = Path("src/strategy_lab/results/exp_021")
...
def main() -> None:
    ...
    artifacts = run_experiment(
        ...
        events=events,
        hypothesis="H1-brake-multi-horizon-consistency-4-5",
    ...
    if artifacts.gate_decision is None:
        raise RuntimeError("EXP-021 did not produce a gate decision")
