...
TF_1M = 60
CANDLES_LOOKBACK = 55
HISTORICAL_M15_COUNT = 2880  # Precarga inicial M15: 30 dias × 96 velas = 2880
...
DURATION_SEC = 900  # expiración de la orden: 15 min (= 3 velas M5 — regla 3-5 candles of working TF)
...
MULTI_DURATION_SECS = (900,)             # 15 min = 3 velas M5
...
HEALTHCHECK_RECONNECT_RETRIES = 3
CF_403_BACKOFF_SEC = 8.0
# Backoff: exponential delay between reconnect attempts (seconds).
# Pattern: 2s, 4s, 8s... capped at MAX_RECONNECT_BACKOFF_SEC.
