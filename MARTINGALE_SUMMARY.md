...
> **⚠️ DOCUMENTO LEGACY (2026-06-29):** La gestión de riesgo activa del bot es
> **Massaniello** (`massaniello_risk.py`). Este archivo describe la integración
> anterior de martingala, conservada solo como referencia histórica.
> Ver `docs/ROADMAP.md` y feature #16 en `feature_list.json`.

## Estado: SUPERSEDED — reemplazado por Massaniello (#16)
