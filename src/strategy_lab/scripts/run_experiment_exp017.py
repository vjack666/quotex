"""Ejecuta EXP-017: brake_transition con rvol>=1.5 + horizonte 4 velas."""
...
REPORT_DIR = Path("src/strategy_lab/results/exp_017")
...
def main() -> None:
    ...
    for pair in PAIRS:
        ...
        indices = np.where((mask) & (rvol >= 1.5))[0]
    ...
    artifacts = run_experiment(
        ...
        events=events,
        hypothesis="H1-brake-rvol-1.5-horizon4",
    ...
    if artifacts.gate_decision is None:
        raise RuntimeError("EXP-017 did not produce a gate decision")
