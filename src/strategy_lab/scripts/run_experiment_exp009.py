"""Ejecuta EXP-009: solo brake_transition=1, sin exigir cruce_en_zona."""
...
REPORT_DIR = Path("src/strategy_lab/results/exp_009")
...
def main() -> None:
    ...
    artifacts = run_experiment(
        ...
        events=events,
        hypothesis="H1-brake-transition-sin-poi",
    ...
    if artifacts.gate_decision is None:
        raise RuntimeError("EXP-009 did not produce a gate decision")
