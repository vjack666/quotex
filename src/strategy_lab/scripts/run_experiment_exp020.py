"""Ejecuta EXP-020: brake_transition con consistencia temporal multi-horizonte."""
...
REPORT_DIR = Path("src/strategy_lab/results/exp_020")
...
def main() -> None:
    ...
    artifacts = run_experiment(
        ...
        events=events,
        hypothesis="H1-brake-multi-horizon-consistency",
    ...
    if artifacts.gate_decision is None:
        raise RuntimeError("EXP-020 did not produce a gate decision")
