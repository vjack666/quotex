"""Ejecuta EXP-022: consistencia 3/5 con evaluación alineada en idx+1."""
...
REPORT_DIR = Path("src/strategy_lab/results/exp_022")
...
def main() -> None:
    ...
    artifacts = run_experiment(
        ...
        events=events,
        hypothesis="H1-brake-multi-horizon-consistency-aligned",
    ...
    if artifacts.gate_decision is None:
        raise RuntimeError("EXP-022 did not produce a gate decision")
